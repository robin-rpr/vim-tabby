...
let s:cdFront = {'gui': '#FFFFFF', 'cterm':  (g:tabby_term256 ? '231' : s:cterm07)}
let s:cdFrontGray = {'gui': '#D4D4D4', 'cterm': (g:tabby_term256 ? '188' : s:cterm05)}
let s:cdBack = {'gui': '#1E1E1E', 'cterm': (g:tabby_term256 ? '234' : s:cterm00)}
let s:cdSelection = {'gui': '#264F78', 'cterm': (g:tabby_term256 ? '24' : s:cterm01)}

let s:cdBlue = {'gui': '#0A7ACA', 'cterm': (g:tabby_term256 ? '32' : s:cterm0D)}
let s:cdLightBlue = {'gui': '#5CB6F8', 'cterm': (g:tabby_term256 ? '75' : s:cterm0C)}
...
let s:cdDarkDark = {'gui': '#232A32', 'cterm': (g:tabby_term256 ? '236' : s:cterm02)}
let s:cdDark = {'gui': '#232A32', 'cterm': (g:tabby_term256 ? '237' : s:cterm03)}
...
let g:airline#themes#tabby#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#tabby#palette.normal_modified = { 'airline_c': s:NM }
let g:airline#themes#tabby#palette.normal.airline_warning = s:Warning
let g:airline#themes#tabby#palette.normal_modified.airline_warning = s:Warning
...
let g:airline#themes#tabby#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#tabby#palette.insert_modified = { 'airline_c': s:IM }
let g:airline#themes#tabby#palette.insert.airline_warning = s:Warning
let g:airline#themes#tabby#palette.insert_modified.airline_warning = s:Warning
...
let g:airline#themes#tabby#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
let g:airline#themes#tabby#palette.replace_modified = { 'airline_c': s:RM }
let g:airline#themes#tabby#palette.replace.airline_warning = s:Warning
let g:airline#themes#tabby#palette.replace_modified.airline_warning = s:Warning
...
let g:airline#themes#tabby#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#tabby#palette.visual_modified = { 'airline_c': s:VM }
let g:airline#themes#tabby#palette.visual.airline_warning = s:Warning
let g:airline#themes#tabby#palette.visual_modified.airline_warning = s:Warning
...
let g:airline#themes#tabby#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
let g:airline#themes#tabby#palette.inactive_modified = { 'airline_c': s:IAM }

" Red accent for readonly:

let g:airline#themes#tabby#palette.accents = {
